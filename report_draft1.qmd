...
p2 <- subplot(plist_all, nrows = 5, margin = 0.02, shareX = TRUE, shareY = FALSE) %>%
  layout(
    title = list(text = "Improved Chart: Dwelling shares with Condo above context (Same x-axis)", x = 0.5, font = list(size = 14)),
